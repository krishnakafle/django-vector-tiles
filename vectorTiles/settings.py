"""
Django settings for vectorTiles project.
...
SECRET_KEY = 'yg_u-wq4wm0(j_i6$0svlmmwhi%xg&imc036q1=@3sr0(4)wqn'
...
WSGI_APPLICATION = 'vectorTiles.wsgi.application'
